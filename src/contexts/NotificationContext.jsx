...
const ConfirmDialog = ({ isOpen, title, message, onConfirm, onCancel }) => {
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center">
      ...
      <div className="relative design-bg-primary rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
        <h3 className="text-lg font-semibold design-text-primary mb-2">{title}</h3>
        <p className="design-text-secondary mb-6">{message}</p>
