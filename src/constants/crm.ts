...
export type CrmStatusName = typeof CRM_STATUS_NAMES[keyof typeof CRM_STATUS_NAMES];
...
export const STATUS_TRANSITIONS: Record<CrmStatusName, { allowed: CrmStatusName[]; label: string }> = {
...
export const PROJECT_STATUS_HEX_COLORS: Record<ProjectStatus, string> = {
...
export const SERVICE_STATUS_HEX_COLORS: Record<ServiceStatus, string> = {
