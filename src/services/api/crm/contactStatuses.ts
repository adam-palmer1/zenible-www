...
const contactStatusesAPI = {
  ...
  createCustomStatus: (statusData: unknown) => request('/crm/contact-statuses/custom', {
    method: 'POST',
    body: JSON.stringify(statusData),
  }),

  /** Update a custom status (including renaming) */
  updateCustomStatus: (statusId: string, statusData: unknown) => request(`/crm/contact-statuses/custom/${statusId}`, {
    method: 'PATCH',
    body: JSON.stringify(statusData),
  }),

  /** Delete a custom status */
  deleteCustomStatus: (statusId: string) => request(`/crm/contact-statuses/custom/${statusId}`, {
    method: 'DELETE',
  }),
};
