...
const companyUsersAPI = {
   ...
   */
  getCompanyUsers: (params: Record<string, unknown> = {}) => {
   ...
   */
  getCompanyUser: (userId: string) => request(`/crm/company/users/${userId}`, { method: 'GET' }),
   ...
   */
  inviteUser: (data: unknown) => request('/crm/company/users/invite', {
    method: 'POST',
   ...
   */
  removeUser: (userId: string) => request(`/crm/company/users/${userId}`, { method: 'DELETE' }),
   ...
   */
  deactivateUser: (userId: string) => request(`/crm/company/users/${userId}/deactivate`, { method: 'POST' }),
   ...
   * @returns {Promise<{status: string, message: string, user_id: string, email: string}>}
   */
  activateUser: (userId: string) => request(`/crm/company/users/${userId}/activate`, { method: 'POST' }),
   ...
   * @returns {Promise<{status: string, message: string, user_id: string}>}
   */
  restoreUser: (userId: string) => request(`/crm/company/users/${userId}/restore`, { method: 'POST' }),
   ...
   */
  grantPermission: (userId: string, permissionCode: string) => request(`/crm/company/users/${userId}/permissions/grant`, {
    method: 'POST',
    body: JSON.stringify({
      user_id: userId,
   ...
   * @returns {Promise<{status: string, permission: string}>}
   */
  revokePermission: (userId: string, permissionCode: string) => request(`/crm/company/users/${userId}/permissions/revoke`, {
    method: 'POST',
    body: JSON.stringify({
      user_id: userId,
      permission_code: permissionCode,
   ...
   */
  updateUserPermissions: (userId: string, permissionCodes: string[]) => request(`/crm/company/users/${userId}/permissions`, {
    method: 'PUT',
    body: JSON.stringify({
      user_id: userId,
