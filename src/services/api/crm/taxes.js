...
const taxesAPI = {
   ...
   */
  create: (taxData) => request(`${baseEndpoint}/`, {
    method: 'POST',
   ...
   */
  update: (taxId, taxData) => request(`${baseEndpoint}/${taxId}`, {
    method: 'PUT',
    body: JSON.stringify(taxData),
  }),
   ...
   */
  delete: (taxId) => request(`${baseEndpoint}/${taxId}`, {
    method: 'DELETE',
  }),
   ...
   */
  reorder: (taxes) => request(`${baseEndpoint}/reorder`, {
    method: 'PUT',
