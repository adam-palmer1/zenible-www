...
import { useCasesCopy } from '../data/copy';
    ...
    <section className="py-20 md:py-28 bg-gray-900">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">
          {useCasesCopy.headline}
        </h2>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {useCasesCopy.personas.map((persona, i) => (
            <div
              key={i}
              className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-5 hover:bg-white/[0.05] transition-colors"
            >
              <div className="w-9 h-9 rounded-xl bg-[#8e51ff]/10 text-[#8e51ff] flex items-center justify-center mb-3">
                {icons[persona.icon]}
              </div>
              <h3 className="text-white font-semibold mb-1">{persona.title}</h3>
