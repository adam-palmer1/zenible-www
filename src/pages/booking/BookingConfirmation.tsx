...
const BookingConfirmation: React.FC = () => {
  ...
  const generateCalendarLinks = (bookingData: any) => {
    ...
    const title = encodeURIComponent(`${bookingData.call_type_name} with ${bookingData.host_name}`);
    const details = encodeURIComponent(bookingData.meeting_link ? `Meeting link: ${bookingData.meeting_link}` : '');
    const location = encodeURIComponent(bookingData.meeting_link || '');
