...
/**
 * Dialog for selecting scope when editing or deleting a recurring appointment
 *
 * @param {object} props
 * @param {boolean} props.isOpen - Whether the dialog is open
 * @param {function} props.onClose - Close handler
 * @param {function} props.onConfirm - Confirm handler (scope) => void
 * @param {'edit'|'delete'} props.mode - Whether this is for edit or delete
 * @param {object} props.appointment - The appointment being edited/deleted
 */
const RecurringScopeDialog = ({ isOpen, onClose, onConfirm, mode = 'edit', appointment }) => {
  ...
  const getScopeDescription = (scopeValue) => {
    const descriptions = {
      'this': isEdit
