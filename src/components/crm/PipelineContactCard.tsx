 ...
 */
const PipelineContactCardContentInner: React.FC<PipelineContactCardContentProps> = ({
  contact,
  isDragging = false,
  onClick,
  onAppointmentClick,
...
export const PipelineContactCardContent = React.memo(PipelineContactCardContentInner);
...
export default React.memo(PipelineContactCard);
