  ...
  useEffect(() => {
    ...
    if (!hasInitializedRef.current) {
      ...
      setServiceItems(prev => {
        ...
        const unsavedServices = prev.filter(s => s.id.toString().startsWith('new-'));

        // Map backend services, keeping local form state for existing ones
        const backendServices = services.map((service, index) => {
          // Check if we have local state for this service
          const existingLocal = prev.find(s => s.id === service.id);
          if (existingLocal) {
              ...
              <div className="p-4 pt-2 space-y-4 border-t border-gray-200">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  >
                    ...
                    <GenericDropdown
                      ...
                      onChange={(value) => handleServiceChange(serviceItem.id, 'currency', value)}
                    ...
                    <GenericDropdown
                      ...
                      onChange={(value) => handleServiceChange(serviceItem.id, 'pricingType', value)}
                ...
                {serviceItem.pricingType === 'Recurring' && (
                  ...
                  >
                    ...
                    <GenericDropdown
                      ...
                      onChange={(value) => handleServiceChange(serviceItem.id, 'recurringType', value)}
                  ...
                  >
                    ...
                    <div className="flex gap-2 items-center">
                      ...
                      <GenericDropdown
                        ...
                        onChange={(value) => handleServiceChange(serviceItem.id, 'customEvery', value)}
                      ...
                      <GenericDropdown
                        ...
                        onChange={(value) => handleServiceChange(serviceItem.id, 'customPeriod', value)}
                ...
                <div className="flex flex-col gap-2 relative">
                  ...
                  <ServiceStatusDropdown
                    ...
                    onSelect={(value) => handleServiceChange(serviceItem.id, 'status', value)}
