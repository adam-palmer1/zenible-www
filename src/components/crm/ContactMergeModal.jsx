...
/**
 * Modal for merging two contacts
 * Source contact (passed as prop) will be merged INTO the selected target contact
 * Target wins for conflicts, source is soft-deleted after merge
 */
const ContactMergeModal = ({ isOpen, onClose, sourceContact, onMergeComplete }) => {
              ...
              {mergeResult.attributes_filled?.length > 0 && (
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {mergeResult.attributes_filled.map((field) => (
                      <span
                        key={field}
