 ...
 * @param {Object} currencies - Currency codes per category: { income, outstanding, expenses }
 * @param {Object} numberFormat - Number formatting options
 */
const FinancialSummary = ({ data, currencies, numberFormat }) => {
  // Format value with the appropriate currency
  const formatValue = (value, currencyCode) => formatCurrencyWithCommas(value, currencyCode, numberFormat);
 ...
 */
const ContactFinancialsTab = ({ contactId }) => {
  const {
    summaryByCurrency,
    summaryCurrencies,
    loading,
