...
/**
 * CRMFiltersBar - Search, filters, and sort controls for CRM
 *
 * Uses the new Dropdown component to eliminate manual positioning logic
 *
 * @param {Object} filters - Current filter state from CRM context
 * @param {Function} updateFilters - Function to update filters
 * @param {Array} allStatuses - Combined global and custom statuses
 * @param {Array} selectedStatuses - Currently selected status IDs
 * @param {Function} handleStatusToggle - Toggle status filter
 * @param {Function} handleClearStatuses - Clear all status filters
 * @param {boolean} showHidden - Whether to show hidden contacts
 * @param {Function} handleShowHiddenToggle - Toggle show hidden
 * @param {string} sortOrder - Current sort order
 * @param {Function} handleSortOrderChange - Change sort order
 * @param {number} activeFilterCount - Number of active filters
 * @param {Function} clearAllFilters - Clear all filters and sort
 */
const CRMFiltersBar = ({
  filters,
  updateFilters,
