...
interface VendorsFiltersBarProps {
  searchQuery: string;
...
/**
 * VendorsFiltersBar - Search, filters, and column selector for Vendors tab
 * Sorting is now handled via clickable column headers in VendorsView
 */
const VendorsFiltersBar: React.FC<VendorsFiltersBarProps> = ({
  searchQuery,
  onSearchChange,
  showHidden,
  onShowHiddenToggle,
          ...
          <div className="space-y-2">
            ...
            <label className="flex items-center gap-3 cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-500 mt-0.5">
                  Display vendors that have been hidden from view
                </div>
              </div>
            </label>
          </div>
...
export default VendorsFiltersBar;
