...
interface AICharacterTypingIndicatorProps {
...
export default function AICharacterTypingIndicator({
  ...
  darkMode = false
}: AICharacterTypingIndicatorProps) {
...
export function TypingDots({ darkMode = false, size = 'md' }: TypingDotsProps) {
...
export function ProcessingBar({ darkMode = false, progress = null }: ProcessingBarProps) {
  return (
