...
interface VariableHelperProps {
  variables?: (string | VariableObject)[];
    ...
    <div className={`space-y-2 ${className}`}>
      ...
      <div className="space-y-2 max-h-96 overflow-y-auto border border-gray-200 dark:border-gray-700 rounded-lg p-3 bg-white dark:bg-gray-800">
        {variables.map((variable, index) => {
          ...
          let variableDesc: string;
          let variableExample: string;
          ...
          if (typeof variable === 'string') {
            ...
            variableName = ((variable as VariableObject).variable || (variable as VariableObject).name || '').replace(/[{}]/g, '');
            variableDesc = (variable as VariableObject).description || '';
            variableExample = (variable as VariableObject).example || '';
          } else {
            variableName = '';
            variableDesc = '';
            variableExample = '';
