...
interface BoardroomAreaProps {
  selectedExperts: any[];
  onExpertDrop: (expert: any) => void;
  onExpertRemove: (expertId: string) => void;
  darkMode: boolean;
}

export default function BoardroomArea({ selectedExperts, onExpertDrop, onExpertRemove, darkMode }: BoardroomAreaProps) {
...
function getAvatarColor(id: string | number) {
  ...
  const index = parseInt(String(id)) % AVATAR_COLORS.length;
