...
export default function PlatformSelector({ darkMode, selectedPlatform, setSelectedPlatform, characterId }) {
  ...
  const fetchPlatforms = async () => {
    try {
      ...
      const fetchedPlatforms = await platformAPI.getActivePlatforms({ characterId });
