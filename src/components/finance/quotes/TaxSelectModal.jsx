  ...
  useEffect(() => {
    if (taxes.length > 0 && initialTaxRate > 0) {
      const matchingTax = taxes.find(t =>
        parseFloat(t.tax_rate) === parseFloat(initialTaxRate) &&
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-gray-900 dark:text-white font-medium">
                        {useCustom
                          ...
                          : selectedTaxId
                            ? `${taxes.find(t => t.id === selectedTaxId)?.tax_name} (${taxes.find(t => t.id === selectedTaxId)?.tax_rate}%)`
                            : 'No tax selected'
                        }
                      </span>
                    </div>
