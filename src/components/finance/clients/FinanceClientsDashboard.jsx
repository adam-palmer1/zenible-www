...
/**
 * Finance Clients Dashboard
 *
 * Shows all clients (contacts with is_client: true) with financial data
 * and allows converting CRM contacts to clients.
 */
const FinanceClientsDashboard = () => {
