 ...
 */
const CurrencySelectModal: React.FC<CurrencySelectModalProps> = ({ isOpen, onClose, currencies, selectedCurrencyId, onSelect, loading, triggerRef }) => {
  ...
  const filteredCurrencies = useMemo(() => {
    ...
    return currencies.filter((cc: any) => {
  ...
  const getCurrencyDisplay = (cc: any) => {
