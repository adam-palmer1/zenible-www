...
/**
 * UnbilledHoursModal - Prompts user to add unbilled hours to an invoice
 *
 * @param {Object} props
 * @param {boolean} props.isOpen - Whether modal is visible
 * @param {Function} props.onClose - Called when modal is dismissed
 * @param {Function} props.onConfirm - Called when user wants to add hours (receives line items array)
 * @param {Object} props.data - API response with items, total_hours, uninvoiced_amount, etc.
 * @param {string} props.defaultCurrency - Company default currency code (fallback)
 * @param {boolean} props.loading - Show loading state
 */
const UnbilledHoursModal = ({
  isOpen,
  onClose,
  onConfirm,
  data,
  ...
  const buildLineItems = () => {
    return projectGroups.map((group) => {
      ...
      const descriptionLines = sortedEntries.map((entry) => {
      ...
      return {
        ...
        _billable_hour_ids: group.entries.map((e) => e.id),
