 ...
 *
 * Dialog for sending invoice payment reminders via email with template selection
 * Uses INVOICE_REMINDER template which includes {{days_overdue}} variable
 ...
 * @param {Object} invoice - Invoice object to send reminder for
