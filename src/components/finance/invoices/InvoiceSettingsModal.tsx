                  ...
                  {!isRecurring && (
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => onChange({ automaticEmail: e.target.checked })}
                        className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                      />
                      <div>
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                ...
                <label className="flex items-center gap-3 cursor-pointer mb-4">
                  <input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => onChange({ overrideReminderSettings: e.target.checked })}
                  ...
                  <div className="space-y-4 pl-7">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => onChange({ invoiceReminderFrequencyDays: e.target.value ? parseInt(e.target.value) : null })}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => onChange({ maxInvoiceReminders: e.target.value !== '' ? parseInt(e.target.value) : null })}
