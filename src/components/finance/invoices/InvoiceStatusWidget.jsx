...
import { FileText, DollarSign, Clock, AlertCircle, TrendingUp, ArrowRight } from 'lucide-react';
...
const InvoiceStatusWidget = () => {
  ...
  const draftCount = invoices.filter(inv => inv.status === INVOICE_STATUS.DRAFT).length;
