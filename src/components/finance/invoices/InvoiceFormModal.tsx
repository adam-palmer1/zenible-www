...
/**
 * Invoice Form Modal Wrapper matching Figma design
 * Clean modal with "Back to Invoice" link and title/cancel header
 */
const InvoiceFormModal: React.FC<InvoiceFormModalProps> = ({ isOpen, onClose, invoice = null, onSuccess }) => {
