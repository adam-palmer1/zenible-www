...
/**
 * ReceiptUpload component for expense receipts
 *
 * @param {Object} props
 * @param {string} props.expenseId - The expense ID (required for upload)
 * @param {Object} props.receipt - Current receipt data { receipt_url, attachment_filename, attachment_size, attachment_type }
 * @param {Function} props.onUpload - Called with receipt data after successful upload
 * @param {Function} props.onDelete - Called after receipt is deleted
 * @param {boolean} props.disabled - Disable upload/delete
