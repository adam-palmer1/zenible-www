          ...
          <form onSubmit={handleSubmit} className="mb-6 p-4 design-bg-secondary rounded-lg">
            <div className="space-y-4">
              <div>
                ...
                <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Category name" className="w-full px-3 py-2 design-input rounded-md" required />
              </div>
              <div>
                <label className="block text-sm font-medium design-text-primary mb-2">Description</label>
                <textarea value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Category description" rows={2} className="w-full px-3 py-2 design-input rounded-md resize-none" />
              </div>
