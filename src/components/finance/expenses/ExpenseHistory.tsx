...
const ExpenseHistory: React.FC<ExpenseHistoryProps> = ({ expenseId }) => {
  ...
  return (
    <div className="space-y-4">
      {formattedChanges.map((change: any) => (
        <div key={change.id} className="flex gap-4 p-4 design-bg-secondary rounded-lg border design-border">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-sm design-text-secondary mb-1">
              ...
              {change.displayOldValue && change.displayNewValue && <span>&rarr; </span>}
