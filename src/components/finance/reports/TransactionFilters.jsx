 ...
 */
const DateRangePicker = ({ startDate, endDate, onPresetSelect, onCustomChange }) => {
  const [isOpen, setIsOpen] = useState(false);
            ...
            <div className="border-t border-gray-200 p-3 space-y-2">
              <div>
                ...
                <input
                  type="date"
                  value={startDate || ''}
                  onChange={(e) => onCustomChange({ start_date: e.target.value })}
              ...
              <div>
                ...
                <input
                  type="date"
                  value={endDate || ''}
                  onChange={(e) => onCustomChange({ end_date: e.target.value })}
                  className="w-full px-2 py-1 text-sm border border-gray-300 rounded"
                />
              </div>
              <button
