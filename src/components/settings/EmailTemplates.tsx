...
const EmailTemplates = () => {
  ...
  const [deleteModal, setDeleteModal] = useState<{ isOpen: boolean; template: any }>({ isOpen: false, template: null });
  ...
  const handleCreateOrEditTemplate = (templateType: string) => {
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="space-y-8">
          {Object.entries(TEMPLATE_CATEGORIES).map(([categoryKey, category]: [string, any]) => (
            <div key={categoryKey}>
              {/* Category Header */}
